...
\noindent \textbf{Kata kunci: Boron nitrida heksagonal; dinamika molekuler; teori fungsional kerapatan; efek termal; defek titik; magnetisme d0.} \textit{} % Kata kunci dalam bahasa Indonesia
