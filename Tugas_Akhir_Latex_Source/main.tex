...
%---------------------------------------------------------------------
    ...
    % LEMBAR PENGESAHAN
    \input{./halaman-depan/pengesahan}
    %\halamanKosong

    % PERNYATAAN ORISINALITAS
    \input{./halaman-depan/pernyataan-keaslian}

    % ABSTRAK
    \input{./halaman-depan/abstrak}
    %\halamanKosong
    
    \input{./halaman-depan/abstract}
    %\halamanKosong
    
    % KATA PENGANTAR 
    \input{./halaman-depan/kataPengantar}
    %\halamanKosong 

    % DAFTAR ISI  
    \input{./halaman-depan/daftarIsi}
    %\halamanKosong 
    
    % DAFTAR GAMBAR
    \input{./halaman-depan/daftarGambar}
    %\halamanKosong
    
    % DAFTAR TABEL
    \input{./halaman-depan/daftarTabel}
    %\halamanKosong
...
%---------------------------------------------------------------------
    ...
    \bibliographystyle{apa-id} % untuk style dengan nama
...
%---------------------------------------------------------------------
    ...
    \input{./halaman-belakang/lampiran/lampiranA}
...
%---------------------------------------------------------------------
    ...
    \input{./halaman-belakang/biografi}
