...
\begin{figure}[h!]
    \centering
    \includegraphics[width=0.9\textwidth]{placeholder_[1]_page1_bs_pdos.png}
...
\begin{figure}[h!]
    \centering
    \includegraphics[width=0.6\textwidth]{placeholder_[1]_page1_chargedensity.png}
...
\begin{table}[h!]
  ...
  \begin{tabular}{lcccc}
    ...
    \bottomrule
  \end{tabular}
  \floatfoot{Sumber data literatur PBE/PBEsol dan Hibrid/GW diadaptasi dari analisis dalam \cite{[1, 1]}.}
\end{table}
...
\begin{table}[h!]
  ...
  \begin{tabular}{lccccc}
    ...
    \bottomrule
  \end{tabular}
  \floatfoot{Data diadaptasi dari [1] dan analisis dalam \cite{[1]}.}
\end{table}

\begin{figure}[h!]
    \centering
    \includegraphics[width=0.9\textwidth]{placeholder_[1]_page2_bs_pdos_800K.png}
...
\begin{figure}[h!]
    \centering
    \includegraphics[width=0.9\textwidth]{placeholder_[1]_page3_bs_pdos_1100K.png}
...
\begin{figure}[h!]
    \centering
    \includegraphics[width=0.9\textwidth]{placeholder_[1]_page4_bs_pdos_1225K.png}
...
\begin{table}[h!]
  ...
  \begin{tabular}{lcccccc}
    ...
    \bottomrule
  \end{tabular}
  \floatfoot{Data diadaptasi dari [1] (hal. 5-7) dan analisis dalam \cite{[1, 1]}.}
\end{table}

\begin{figure}[h!]
    \centering
    \includegraphics[width=0.9\textwidth]{placeholder_[1]_page5_bs_pdos_NN_800K.png}
    \caption{Struktur pita elektronik dan PDOS untuk monolayer hBN dengan defek N$_B$ pada 800K. [1]}
    \label{fig:hbn_NN_800K}
\end{figure}
\begin{figure}[h!]
    \centering
    \includegraphics[width=0.9\textwidth]{placeholder_[1]_page6_bs_pdos_NN_1100K.png}
    \caption{Struktur pita elektronik dan PDOS untuk monolayer hBN dengan defek N$_B$ pada 1100K. [1]}
    \label{fig:hbn_NN_1100K}
\end{figure}
\begin{figure}[h!]
    \centering
    \includegraphics[width=0.9\textwidth]{placeholder_[1]_page7_bs_pdos_NN_1225K.png}
    \caption{Struktur pita elektronik dan PDOS untuk monolayer hBN dengan defek N$_B$ pada 1225K. [1]}
    \label{fig:hbn_NN_1225K}
\end{figure}
\begin{figure}[h!]
    \centering
    \includegraphics[width=0.6\textwidth]{placeholder_[1]_page7_chargedensity_NN_1225K.png}
...
\begin{table}[h!]
  ...
  \floatfoot{Data diadaptasi dari [1] (hal. 8-10) dan analisis dalam \cite{[1, 1]}. VBM/CBM merujuk pada nilai sistem total; panah menunjukkan kanal spin dominan jika ada pemisahan spin yang jelas.}
\end{table}

\begin{figure}[h!]
    \centering
    \includegraphics[width=0.9\textwidth]{placeholder_[1]_page8_bs_pdos_BB_800K.png}
    \caption{Struktur pita elektronik dan PDOS untuk monolayer hBN dengan defek B$_N$ pada 800K. [1]}
    \label{fig:hbn_BB_800K}
\end{figure}
\begin{figure}[h!]
    \centering
    \includegraphics[width=0.9\textwidth]{placeholder_[1]_page9_bs_pdos_BB_1100K.png}
...
\begin{figure}[h!]
    \centering
    \includegraphics[width=0.9\textwidth]{placeholder_[1]_page10_bs_pdos_BB_1225K.png}
...
\begin{figure}[h!]
    \centering
    \includegraphics[width=0.6\textwidth]{placeholder_[1]_page10_spindensity_BB_1225K.png}
...
\subsection{Korelasi Modifikasi Struktural (dari MD) dengan Fenomena Elektronik dan Magnetik}
